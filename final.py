...
# =========================================================================
# 6. EXPORT FINAL TRAINED PIPELINE
# =========================================================================
...
final_pipeline = Pipeline([
    ...
    ('selector', SelectKBest(k=12)),       # feature selection step
    ('classifier', best_svc_model)         # optimized classifier
])
...
print("✔️ Full pipeline (scaler + selector + optimized SVM) saved to:", MODEL_FILENAME)
...
# Build a full pipeline including preprocessing
final_pipeline = Pipeline([
    ('scaler', StandardScaler()),          # scaling step
    ('selector', SelectKBest(k=12)),       # feature selection step
    ('classifier', best_svc_model)         # optimized classifier
...
print("✔️ Full pipeline (scaler + selector + classifier) saved to:", MODEL_FILENAME)
